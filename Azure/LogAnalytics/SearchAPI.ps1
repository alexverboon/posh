...
$subscrID = "53fac23e-0234-4ab0-9097-0bd02896b7cf"
$WorkspaceName = "automation01oms"
$resourcegroupname = "rg_automation01"
$WorkspaceID = "197c29e4-5914-40e7-bea0-7a718679f5f7"

Import-Module -FullyQualifiedName "D:\dev\posh\Azure\LogAnalytics\LogAnalyticsQuery.psm1" -DisableNameChecking
